...
class AppColors {
  ...
  static const Color primaryColor = Color.fromRGBO(44, 61, 108, 1);
  static const Color secondaryColor =  Color.fromRGBO(239, 240, 239, 1);

  static const Color primaryTextTextColor =  Color.fromARGB(255, 255, 255, 255);
  static const Color secondaryTextColor =  Color.fromARGB(198, 0, 37, 201);
  ...
  static const Color focusUnderLineColor =  Color.fromARGB(255, 255, 255, 255);
